...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[220vh] md:h-[250vh] lg:h-[350vh]  py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product relative flex-shrink-0 h-64 sm:h-80 md:h-96 w-[18rem] sm:w-[22rem] md:w-[30rem]"
    >
      <Image
