    ...
    <Popover>
      ...
      <PopoverContent className="w-96 p-5 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300">
        <div className="flex justify-between items-center mb-4">
          <h4 className="font-semibold text-xl text-gray-800 dark:text-gray-100">🛒 Your Cart</h4>
          {cartItems.length > 0 && (
            <Button
              size="sm"
              variant="destructive"
        ...
        {loading ? (
          ...
          <div className="text-center text-gray-500 py-10">
            <p className="font-medium text-gray-600 dark:text-gray-300">Your cart is empty 😔</p>
